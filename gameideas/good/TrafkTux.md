...
yay -S calamares xwaylandvideobridge pamac-all hyprshade
...
* #### Waybar (FERTIG)
  hat links app menu, power menu, show first 9 workspaces(hyprexo), hideall, danach abstand und dann terminal,  und firefox   mitte aktive workspaces und geöffnete apps    rechts audio, bluetooth, internet und uhrzeit
