...
* breeze-Theme anpassen
  ...
  # Was bis jrtzt zum übernehmen wäre
  ~/.config (vorher firefox dings und so löschen, ABER Theme beibehalten was installiert und aktiviert ist)
  /usr/share/icons
  ~/.local/share/trafkhop-entertainment